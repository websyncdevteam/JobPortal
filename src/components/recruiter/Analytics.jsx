...
const Analytics = () => {
  const { stats, loading, fetchRecruiterData } = useRecruiter();
  ...
  const pieData = [
    ...
    { name: 'Reviewed', value: stats.statusCounts.reviewed },
    { name: 'Interview', value: stats.statusCounts.interview },
    { name: 'Hired', value: stats.statusCounts.hired },
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-xl shadow p-6 text-center">
          ...
          <p className="text-3xl font-bold mt-2">{stats.totalHired}</p>
        </div>
        <div className="bg-white rounded-xl shadow p-6 text-center">
          <h2 className="text-gray-500 font-medium">Pending Interviews</h2>
          <p className="text-3xl font-bold mt-2">{stats.pendingInterviews}</p>
        </div>
      </div>
