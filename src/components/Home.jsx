...
import { Search, Building, Users, Target, Shield, MapPin, DollarSign, Calendar, Briefcase, ArrowRight, Phone, Mail, Linkedin, Sparkles, Rocket, Zap } from "lucide-react";
          ...
          <div className="flex items-start justify-between mb-6 relative z-10">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 font-medium text-sm mt-1">{job.company?.name}</p>
              </div>
            </div>
            {job.urgent && (
              <motion.span
          ...
          <div className="space-y-4 flex-1 relative z-10">
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <span className="text-sm text-gray-600">{job.salary || "Negotiable"}</span>
              </motion.div>
              ...
              >
                ...
                <span className="text-sm text-gray-600">{job.jobType || "Full-time"}</span>
              </motion.div>
              ...
              >
                ...
                <span className="text-sm text-gray-600">{job.experience || "Any"}</span>
              </motion.div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20 md:pt-32 md:pb-32 relative z-10">
            <div className="text-center">
              ...
              >
                ...
                >
                  Direct connections with 500+ top companies. We bridge talent with opportunity through 
              ...
              >
                ...
                <div className="flex flex-wrap justify-center gap-3 mt-6">
                  {["Software Engineer", "Marketing", "Remote", "Urgent Hiring", "Finance", "Design"].map((tag, i) => (
                    <motion.button
                      key={tag}
              ...
              {stats && (
                ...
                >
                  {[
                    { value: stats.totalJobs, label: "Active Jobs", color: "text-[#13419E]" },
                    { value: stats.totalCompanies, label: "Partner Companies", color: "text-[#119FE6]" },
                    { value: stats.urgentJobs, label: "Urgent Positions", color: "text-[#72BBE8]" },
                    { value: stats.remoteJobs, label: "Remote Roles", color: "text-[#FE0303]" },
                  ].map((stat, i) => (
                    <motion.div
                      key={i}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                We maintain exclusive recruitment partnerships with top companies across sectors
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
              {featuredCompanies.map((company, index) => (
                ...
                >
                  ...
                  <p className="text-sm text-[#13419E] font-medium">{company.jobs} openings</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-600 text-lg max-w-3xl mx-auto">
                We're not just another job portal. We're strategic recruitment partners with direct company connections.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="p-8 rounded-2xl border border-gray-100 hover:border-[#13419E]/20 hover:shadow-lg transition-all">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-4">Direct Company Access</h3>
                <p className="text-gray-600">
                  Exclusive partnerships with 500+ companies who trust us with their hiring needs.
                </p>
              </div>
              ...
              <div className="p-8 rounded-2xl border border-gray-100 hover:border-[#13419E]/20 hover:shadow-lg transition-all">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-4">Strategic Matching</h3>
                <p className="text-gray-600">
                  We understand company culture and candidate profiles for perfect placements.
                </p>
              </div>
              ...
              <div className="p-8 rounded-2xl border border-gray-100 hover:border-[#13419E]/20 hover:shadow-lg transition-all">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-4">Priority Consideration</h3>
                <p className="text-gray-600">
                  Applications through AIM9HIRE get priority review by our partner companies.
                </p>
              </div>
            </div>
          </div>
            ...
            {filteredJobs.length === 0 ? (
              <div className="text-center py-16 bg-white rounded-2xl">
                ...
                <p className="text-gray-600 mb-8 max-w-md mx-auto">
                  {searchQuery ? `Try different keywords` : "New opportunities coming soon"}
                </p>
              </div>
            ) : (
              <>
                <div className="mb-8">
                  <p className="text-gray-600">
                    Showing <span className="font-bold text-purple-700">{filteredJobs.length}</span> of <span className="font-bold">{allJobs.length}</span> jobs
        ...
        <div className="relative py-20 overflow-hidden">
          ...
          <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-white/90 mb-10 max-w-3xl mx-auto">
              Join thousands of professionals who found their dream roles through our exclusive company connections.
            </p>
